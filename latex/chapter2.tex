...
sotto forma di prodotto: $ \bm h^\ell = \bm \Theta^{\ell-1} \bm h^{\ell-1}$. Se
...
L'algoritmo calcola il gradiente della funzione di costo
...
della programmazione dinamica per evitare di ricalcolare
più volte la derivata di branch comuni dell'albero di computazione, rendendolo
di fatto un metodo molto efficiente.
