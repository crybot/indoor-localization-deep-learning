...
\def\AvgPoolColor{rgb:blue,1.0;green,0.2;white,0.45}
...
%         xlabel=1, zlabel=128,fill=\FcColor, bandfill=\FcReluColor,opacity=0.5,%
%         height=2, width=2, depth=120}};
\pic[shift={(\fcsep,0,0)}] at (fc1-east) {Box={name=auxout1, caption=aux\_output,%
        captiongap=20pt,%
        xlabel=1, zlabel=2,fill=\FcColor, opacity=0.5,%
        height=2, width=2, depth=6}};

%%%%% AUX-INPUT-2 %%%%%
\pic[shift={(0,0,5)}] at (auxout1-east) {Box={name=auxin2, caption=aux2,%
        captiongap=20pt,%
        xlabel={{"1", ""}}, zlabel=2,%
...
\pic[shift={(3.5,0,0)}] at (auxout1-east) {RightBandedBox={name=fc3, caption=fc3,%
        xlabel=1, zlabel=128,fill=\FcColor, bandfill=\FcReluColor,opacity=0.5,%
        height=2, width=2, depth=120}};
\pic[shift={(\fcsep,0,0)}] at (fc3-east) {Box={name=fc5, caption=output,%
        xlabel=1, zlabel=2,fill=\FcColor, opacity=0.5,%
        height=2, width=2, depth=6}};
